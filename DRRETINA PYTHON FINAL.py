...
class NewWin():
   ...
   def __init__(self):
       ...
       self.img3 = ImageTk.PhotoImage(Image.open("drmain222.png"))  
       l22 = tk.Label(self.win, image=self.img3,width=700,relief="ridge",fg="#323223",font=("calibri",14,"bold"))
       l22.place(x=00,y=0)


       self.img2 = ImageTk.PhotoImage(Image.open("drmain222.png"))  
       l11 = tk.Label(self.win, image=self.img2,width=700,relief="ridge",fg="#323223",font=("calibri",14,"bold"))
       l11.place(x=0,y=0)
...
#       l33 = tk.Label(self.win, image=self.img3,width=450,relief="ridge",fg="#323223",font=("cambria",14,"bold"))
 #      l33.place(x=0,y=150)
       ...
       self.b2 = tk.Button(self.win,text=" Select Data Set File  ",width=25,bg="#ffffff",fg="black",relief="raised",font=("calibri",13,"bold"),command=self.callback)
  ...
  #     self.l12 = tk.Label(self.win,text=" Cancer Disease Prediction System  ",width=55,bg="darkblue",fg="white",relief="raised",font=("magenta",15,"bold"))
   ...
   def callback(self):
       ...
       print(self.name)
       self.t1 = tk.Label(self.win,text="",width=22,relief="raised",bg="darkblue",fg="white",font=("calibri",14,"bold"))
...
#             
   ...
   def loading(self):
       ...
       print("File Name="+fname)
       if(fname==""):       
           tkinter.messagebox.showinfo(" Diabetic Retinopathy Detection System "," Please Enter File Name....");
       else:
           tkinter.messagebox.showinfo(" Diabetic Retinopathy Detection System "," Data set of File="+fname+" is Loading ...Please Wait...");
           self.dataload()
#       self.win.destroy()
 #      app=Test()
 
   def dataload(self):
       tkinter.messagebox.showinfo(" Diabetic Retinopathy Detection System "," Data Loading Functio is Called...");
       fname=self.name
...
#       sql="insert into emp values('jjj','222','Tester','12000','2015-2-2','40','25')";
 ...
 #      sql="select * from emp"
       ...
       print(" All Data Transfered And Stored into DataBase....");    
...
#       self.load.configure(bg="#912388")
       ...
       l1 = tk.Label(self.canvas,text=" Diabetic Retinopathy Eye Patients Data Set Details ",width=50,relief="raised",bg="#2fafcf",fg="white",font=("calibri",14,"bold"))
       l1.place(x=300,y=20)
       ...
       ttk.Style().configure("Treeview", background="#213473",foreground="white", fieldbackground="#1fbae1",font=('calibri', 10,'bold'))
...
class Analysis():
   def __init__(self):
       ...
       self.canvas = tk.Canvas(self.ana, width = 700, height = 380, bg="white")  
       self.canvas.place(x=0,y=0);

       self.img1 = ImageTk.PhotoImage(Image.open("drmain3333.png"))  
       l1 = tk.Label(self.ana, image=self.img1,width=700,relief="ridge",fg="black",font=("calibri",14,"bold"))
       l1.place(x=0,y=00)
...
#       l2 = tk.Label(self.ana,text=" DR Retina  Data Analysis for Disease Prediction  ",width=50,relief="groove",bg="#092193",fg="yellow",font=("cambria",14,"bold"))
 #      l2.place(x=200,y=30)
       ...
       b1 = tk.Button(self.ana,text=" Extract Featured Attribute  ",width=30,bg="white",fg="black",relief="groove",font=("calibri",12,"bold"),command=self.featureextraction)
...
#       b3 = tk.Button(self.ana,text=" Prediction Of Crop ",width=30,bg="#c82210",fg="yellow",relief="groove",font=("cambria",12,"bold"),command=self.prediction)
 #      b3.place(x=150,y=180)
       ...
       b4 = tk.Button(self.ana, text=" Exit ",width=30,bg="white",fg="red",relief="groove",font=("calibri",12,"bold"),command=self.exit)
...
#       self.load.configure(bg="#912388")
       ...
       l1 = tk.Label(self.canvas,text=" Extracted Featured Attributes Details Of Patients ",width=50,relief="raised",bg="#235687",fg="white",font=("calibri",14,"bold"))
       l1.place(x=250,y=20)
       ...
       self.ysb = ttk.Scrollbar(self.tv, orient=tk.VERTICAL, command=self.tv.yview)
       self.xsb = ttk.Scrollbar(self.tv, orient=tk.HORIZONTAL, command=self.tv.xview)
       ttk.Style().configure("Treeview", background="black",foreground="white", fieldbackground="red",font=('calibri', 10,'bold'))
       self.tv.configure(yscroll=self.ysb.set, xscroll=self.xsb.set)
       ...
       b1 = tk.Button(self.canvas1,text=" Predict DR Retina Disease  ",width=40,relief="raised",bg="#235687",fg="white",font=("calibri",14,"bold"),command=self.loading)
       b1.place(x=500,y=14)
...
#       self.prediction.configure(bg="#232342")
       ...
       self.img1 = ImageTk.PhotoImage(Image.open("drpre11.png"))  
...
#       l2 = tk.Label(self.prediction,text=" Prediction of Disease   ",width=50,relief="groove",bg="#092193",fg="yellow",font=("cambria",14,"bold"))
 #      l2.place(x=30,y=30)
       ...
       b1 = tk.Button(self.prediction,image=self.img1,width=400,bg="darkblue",fg="yellow",relief="raised",font=("calibri",12,"bold"),command=self.croppred)
       b1.place(x=0,y=0)
...
#       self.load.configure(bg="#912388")
       ...
       l1 = tk.Label(self.canvas,text=" DR Retina Eye Disease Predicted Result Details ",width=50,relief="raised",bg="grey",fg="white",font=("calibri",14,"bold"))
       l1.place(x=300,y=20)
       ...
       self.ysb = ttk.Scrollbar(self.tv, orient=tk.VERTICAL, command=self.tv.yview)
       self.xsb = ttk.Scrollbar(self.tv, orient=tk.HORIZONTAL, command=self.tv.xview)
       ttk.Style().configure("Treeview", background="black",foreground="white", fieldbackground="#19b1fc",font=('calibri', 10,'bold'))
       self.tv.configure(yscroll=self.ysb.set, xscroll=self.xsb.set)
       ...
       b1 = tk.Button(self.canvas1,text=" Analyse The Result ",width=25,relief="raised",bg="red",fg="white",font=("calibri",14,"bold"),command=self.dataload1)
       b1.place(x=500,y=14)
...
class Classification():
   def __init__(self):
       ...
       self.img2 = ImageTk.PhotoImage(Image.open("drclass1.png"))  
       l2 = tk.Label(self.classify, image=self.img2,width=800,relief="groove",fg="#323223",font=("calibri",14,"bold"))
       l2.place(x=0,y=00)
...
#       l2 = tk.Label(self.classify,text=" DR Retina Disease Data Analyse On Different Criteria  ",width=60,height=2,relief="groove",bg="#092193",fg="yellow",font=("cambria",14,"bold"))
 #      l2.place(x=100,y=30)
       ...
       b1 = tk.Button(self.classify,text=" DR Disease Class  ",width=27,bg="#122137",fg="yellow",relief="groove",font=("calibri",13,"bold"),command=self.diseaseclass)
       b1.place(x=70,y=300)
       
       b3 = tk.Button(self.classify,text=" Gender ",width=27,bg="#122137",fg="yellow",relief="groove",font=("calibri",13,"bold"),command=self.gender)
       b3.place(x=440,y=300)

       b2 = tk.Button(self.classify,text=" Age ",width=27,bg="#122137",fg="yellow",relief="groove",font=("calibri",13,"bold"),command=self.age)
       b2.place(x=440,y=380)

       b4 = tk.Button(self.classify,text=" Exit ",width=27,bg="#122137",fg="yellow",relief="groove",font=("calibri",13,"bold"),command=self.exit)
       b4.place(x=70,y=380)
...
#       self.load.configure(bg="#912388")
 ...
 #      select * from collegedataset where cname='BIET' order by sem,dept desc;
       ...
       l1 = tk.Label(self.canvas,text=" Diabetic Retinopathy Data Analysis Based on Gender Group ",width=50,relief="raised",bg="lightblue",fg="white",font=("calibri",14,"bold"))
       l1.place(x=50,y=20)
       ...
       self.ysb = ttk.Scrollbar(self.tv, orient=tk.VERTICAL, command=self.tv.yview)
       self.xsb = ttk.Scrollbar(self.tv, orient=tk.HORIZONTAL, command=self.tv.xview)
       ttk.Style().configure("Treeview", background="#768324",foreground="white", width="300" ,font=('calibri', 11,'bold'))
       self.tv.configure(yscroll=self.ysb.set, xscroll=self.xsb.set)
...
#       self.tv.bind("<ButtonRelease-1>",self.selected)
       ...
       b2 = tk.Button(self.canvas1,text=" Analyze Data Using Graph ",width=45,relief="raised",bg="lightblue",fg="black",font=("calibri",12,"bold"),command=self.graph)
       b2.place(x=260,y=12)

       b3 = tk.Button(self.canvas1,text=" Back  ",width=20,relief="raised",bg="lightblue",fg="black",font=("calibri",12,"bold"),command=self.back)
       b3.place(x=30,y=12)
...
#       self.graph2.configure(bg="#912388")
       ...
       b1 = tk.Button(self.canvas,text=" Back  ",width=35,relief="raised",bg="darkblue",fg="white",font=("calibri",13,"bold"),command=self.back)
       b1.place(x=750,y=20)
...
#       self.load.configure(bg="#912388")
 ...
 #      select * from collegedataset where cname='BIET' order by sem,dept desc;
       ...
       l1 = tk.Label(self.canvas,text=" Diabetic Retinopathy Data Analysis Based on Age Group ",width=50,relief="raised",bg="darkred",fg="white",font=("calibri",14,"bold"))
       l1.place(x=50,y=20)
...
#       self.tv.bind("<ButtonRelease-1>",self.selected)
       ...
       b2 = tk.Button(self.canvas1,text=" Classify Age Group ",width=45,relief="raised",bg="purple",fg="white",font=("calibri",12,"bold"),command=self.graph)
       b2.place(x=260,y=12)

       b3 = tk.Button(self.canvas1,text=" Back  ",width=20,relief="raised",bg="purple",fg="white",font=("calibri",12,"bold"),command=self.back)
       b3.place(x=30,y=12)
   ...
   def graph(self):
      # self.load.destroy()
       ...
       tkinter.messagebox.showinfo(" Diabetic Retinopathy Disease Data Data Analysis "," Diabetic Retinopathy Data Processingn on Age Group Processing classification Begins ...")
       mdb = mysql.connect(host = "localhost",user = "root",passwd = "mj",database="drretina",use_pure= "True",charset='utf8')
       cursor = mdb.cursor()
...
#       self.load.configure(bg="#912388")
 ...
 #      select * from collegedataset where cname='BIET' order by sem,dept desc;
       ...
       l1 = tk.Label(self.canvas,text=" DR Retina Disease  Data Analysis Based on Age Group ",width=50,relief="raised",bg="darkred",fg="white",font=("calibri",14,"bold"))
       l1.place(x=50,y=20)
       ...
       b2 = tk.Button(self.canvas1,text=" Analyse using Graph  ",width=45,relief="raised",bg="darkred",fg="white",font=("calibri",12,"bold"),command=self.graph)
       b2.place(x=60,y=12)

       b3 = tk.Button(self.canvas1,text=" Back  ",width=20,relief="raised",bg="darkred",fg="white",font=("calibri",12,"bold"),command=self.back)
       b3.place(x=500,y=12)
...
#       self.graph2.configure(bg="#912388")
       ...
       l1 = tk.Label(self.canvas,text=" DR Retina Disease Data Analysis Based On Age Group Class ",width=50,relief="raised",bg="darkred",fg="white",font=("calibri",14,"bold"))
       l1.place(x=150,y=20)
...
#       self.load.configure(bg="#912388")
 ...
 #      select * from collegedataset where cname='BIET' order by sem,dept desc;
       ...
       l1 = tk.Label(self.canvas,text=" DR Retina Disease Data Analysis Based on Disease Class ",width=50,relief="raised",bg="darkred",fg="white",font=("calibri",14,"bold"))
       l1.place(x=50,y=20)
...
class Test():
   def __init__(self):
       ...
       self.img1 = ImageTk.PhotoImage(Image.open("main2.png"))  
#       l1 = tk.Label(self.root, image=self.img1,width=1000,relief="ridge",fg="#323223",font=("cambria",14,"bold"))
 #      l1.place(x=0,y=00)



       b1 = tk.Button(self.root,image=self.img1,width=1380,height=720,bg="white",fg="white",relief="raised",font=("calibri",14,"bold"),command=self.createNewWindow)
       b1.place(x=0,y=0) 
